...
public class RobotokTippelnekGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtAreaEgy = new javax.swing.JTextArea();
        ...
        txtAreaEgy.setColumns(20);
        txtAreaEgy.setRows(5);
        txtAreaEgy.setText("A kitalálandó szám: 1\nAz 1. tipp: 2\nA 2. tipp: 7\nA 3. tipp: 7\nNem siekrült háromból eltalálni!\n\nA kitalálandó szám: 1\nAz 1. tipp: 3\nA 2. tipp: 6\nA 3. tipp: 3\nNem siekrült háromból eltalálni!");
        jScrollPane2.setViewportView(txtAreaEgy);
    ...
    private void btnGeneralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGeneralActionPerformed
        boolean selected = cbKulon.isSelected();
        ...
        if (selected) {
            ...
            int szam1;
            int szam2;
            int db = maxValue - minValue + 1;
            szam1 = (int)(Math.random() * db) + minValue;
            szam2 = (int)(Math.random() * db) + minValue;
            if (szam1 == szam2){
                szam1 = (int)(Math.random() * db) + minValue;
                szam2 = (int)(Math.random() * db) + minValue;
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (mindentMutat) {
            txtAreaHarom.setText("A kitalálandó szám: " + kitalalando + "\n"
    ...
    private void kilepes() {
        ...
        //System.out.println("Válasz = " + valasz);
    ...
    private javax.swing.JTextArea txtAreaEgy;
